...
const PortalInfographic = memo(() => {
  ...
  const SERVICES = [
    { id: 1, label: 'ERP Integration', icon: '⚙️', color: '#1e78ec' },
    { id: 2, label: 'Automation', icon: '🤖', color: '#0e8d6d' },
    { id: 3, label: 'Data Entry', icon: '📋', color: '#515e7b' },
    { id: 4, label: 'Tech Support', icon: '🎧', color: '#8b5cf6' },
    { id: 5, label: 'Supply Chain', icon: '🔗', color: '#f59e0b' },
    { id: 6, label: 'Doc Mgmt', icon: '📁', color: '#1e78ec' },
    { id: 7, label: 'BOM Lifecycle', icon: '🔧', color: '#84cc16' },
  ];
  ...
  return (
    <motion.div
      ...
      className="flex-1 min-w-0 w-full h-[320px] sm:h-[380px] md:h-[420px] lg:h-[480px] xl:h-[520px] flex items-center justify-center relative perspective-[1200px]"
      ...
      >
        <svg viewBox="0 0 920 440" className="w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" style={{ transform: 'translateZ(20px)' }}>
          ...
          <g transform="translate(30, 115)">
            ...
            <text x="67" y="165" textAnchor="middle" fontSize="8" fontWeight="800" fill="#515e7b" letterSpacing="0.1em" fontFamily="Inter, sans-serif">INCOMING</text>
            <text x="67" y="178" textAnchor="middle" fontSize="7" fill="#8593ae" fontFamily="Inter, sans-serif">Raw & Unstructured</text>
          </g>
          ...
          <g transform="translate(280, 30)">
            ...
            <text x="170" y="24" textAnchor="middle" fontSize="8" fontWeight="700" fill="white" opacity="0.85" letterSpacing="0.12em" fontFamily="Inter, sans-serif">BAAVA TECH OPERATIONS HUB</text>

            {/* Inner panel */}
            <rect x="14" y="48" width="312" height="275" rx="10" fill="#f5f3f0" stroke="#ddd8d0" strokeWidth="0.8" />
            <text x="32" y="66" fontSize="6.5" fontWeight="700" fill="#515e7b" letterSpacing="0.07em" fontFamily="Inter, sans-serif">ACTIVE OPERATIONS</text>
                ...
                >
                  ...
                  {arrived ? (
                    <>
                      ...
                      <text x="38" y={yPos + 17} fontSize="11">{svc.icon}</text>
                      <text x="54" y={yPos + 17} fontSize="8" fontWeight="700" fill="#333a48" fontFamily="Inter, sans-serif">{svc.label}</text>
                      <circle cx="290" cy={yPos + 13} r="7" fill={svc.color} opacity="0.12" />
                      <text x="290" y={yPos + 16.5} textAnchor="middle" fontSize="9" fill={svc.color}>✓</text>
                    </>
                  ) : (
                    <>
            ...
            <text x="170" y="332" textAnchor="middle" fontSize="7" fontWeight="600" 
            ...
            <g transform="translate(306, -10)">
              ...
              <text x="0" y="5" textAnchor="middle" fontSize="12" fill="white">🛡️</text>
              {allArrived && (
            ...
            {SERVICES.map((svc, i) => {
              ...
              return (
                <motion.g 
                  ...
                  whileHover={{ scale: 1.03, x: 4, opacity: 1 }}
                  className="cursor-pointer"
                >
                  ...
                  <text x="28" y={yPos + 15} fontSize="11">{svc.icon}</text>
                  <text x="44" y={yPos + 14} fontSize="7.5" fontWeight="700" fill="#333a48" fontFamily="Inter, sans-serif">{svc.label}</text>
                  <text x="44" y={yPos + 25} fontSize="5.5" fill="#515e7b" fontFamily="Inter, sans-serif">Structured & Secured</text>
                  {isActive && (
                    <g transform={`translate(144, ${yPos + 12})`}>
                      <circle r="5" fill={svc.color} opacity="0.12" />
                      <text x="0" y="3.5" textAnchor="middle" fontSize="7" fill={svc.color}>✓</text>
                    </g>
                  )}
                </motion.g>
              );
          ...
          {/* ── Flow Labels ── */}
          <text x="215" y="175" textAnchor="middle" fontSize="7" fontWeight="700" fill="#f59e0b" opacity="0.55" letterSpacing="0.08em" fontFamily="Inter, sans-serif">YOU SUBMIT</text>
          <text x="675" y="175" textAnchor="middle" fontSize="7" fontWeight="700" fill="#0e8d6d" opacity="0.55" letterSpacing="0.08em" fontFamily="Inter, sans-serif">YOU RECEIVE</text>

          {/* ── Bottom Label ── */}
          <g transform="translate(280, 415)">
            <rect x="0" y="0" width="340" height="22" rx="11" fill="#22272f" opacity="0.04" />
            <text x="170" y="15" textAnchor="middle" fontSize="7" fontWeight="700" fill="#22272f" opacity="0.45" letterSpacing="0.14em" fontFamily="Inter, sans-serif">
